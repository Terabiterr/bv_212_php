...
@section('content')
    ...
    <form class="col-12 d-flex justify-content-center align-items-center flex-column" action="{{route('home.assistant_update')}}" method="post">
        @csrf <!--https://laravel.com/docs/11.x/csrf-->
        <div class="col-5">
            <label for="id" class="form-label">Id</label>
            <input type="number" class="form-control" name="id" id="idId">
        </div>
        <div class="col-5">
